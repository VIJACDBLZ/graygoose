...
(function($) {
    ...
    $.fn.smart_modal_add_show = function(ele) {
        return $.smart_modal.show(ele);
    };
    ...
    $.smart_modal = {
        ...
        get_content:function(trig) {
            ...
            if (trig.attr("rel")) { //if rel exists
                ...
                if (trig.attr('title')) {
                    c += "<h3 class='sm_title'>" + trig.attr('title') + "</h3><img src='" + trig.attr('href') + "' alt='" + trig.attr('title') + "' />";
                }
                else {
                    c += "<img src='" + trig.attr('href') + "' alt='sm_modal' />";
                }
            } else {
                c = c + trig.html();
            }
